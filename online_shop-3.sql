...
--
-- Host: localhost
-- Czas generowania: 17 Sie 2017, 14:29
...
INSERT INTO `Products` (`id`, `name`, `price`, `description`, `releaseDate`) VALUES
(1, 'Movie 1', 11, 'Description movie 1', '2010');
...
(3, 'example ', 'example', 'example@example', '$2y$10$yHpmHJIf5W9.yGJrC37hveIsU2PhbZuvmm1ZGkcFsx2sm/FauRcra', 1),
(4, 'example2', 'example', 'example2@example', '$2y$10$WVfEkvNIqrqv.Hxn9.xRyO3fPpewzIKQd6r.qPjsZp99t0JCB/ZU6', 1);
